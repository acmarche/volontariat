...
class ActiviteController extends AbstractController
{
    ...
    public function delete(Activite $activite, Request $request) : RedirectResponse
    {
    ...
    private function createDeleteForm(Activite $activite): FormInterface
    {
        return $this->createFormBuilder()
            ->set($this->generateUrl('volontariat_admin_activite_delete', array('id' => $activite->getId())))
